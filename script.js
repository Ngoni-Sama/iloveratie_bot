    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage(`
                    Hello there 👋🏻,<br><br>
                    My name is <span class='bold'><a class='alink'>Sober9 Bot</a>.</span><br><br>
                    I’m here to support you on your journey to sobriety and well-being. 🌱✨<br><br>
                    Whether you’re facing challenges or just need someone to talk to, I’m all ears!<br><br>
                    Send <span class='bold'>'help'</span> to explore resources, get advice, or simply chat.<br><br>
                    Remember, you’re not alone in this journey. Together, we can find a way forward! 💪❤️
                `);
            }, 2000);
